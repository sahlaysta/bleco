...
final class GUIMessageBox {
	...
	static void showAboutMsg(GUI gui) {
		...
		//About pane
		jtp.add("About", getUneditableJTextArea(ABOUT_MSG));
		
		//License pane
		jtp.add("License", getUneditableJTextArea(LICENSE_MSG));
	...
	private static JComponent getUneditableJTextArea(String text) {
		JTextArea jta = new JTextArea();
		jta.setText(text);
		jta.setLineWrap(true);
		jta.setWrapStyleWord(true);
		jta.setCaretPosition(0);
		AbstractDocument ad = (AbstractDocument)jta.getDocument();
		ad.setDocumentFilter(EMPT_DOC_FILTER);
