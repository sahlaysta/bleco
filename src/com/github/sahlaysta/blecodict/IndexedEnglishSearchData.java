...
/** Indexed and normalized CC-CEDICT searching
 * by the English definitions of CC-CEDICT
...
final class IndexedEnglishSearchData {
	...
	writeData(
		 ...
		 * definition, to the int index of
	 ...
	 * multivaluemap */
	static final void addToMultiValueMap(
			String definition,
			int index,
			MultiValueMap<String, Integer> mvm) {
	...
	static final void putToMultiValueMap(
			String str,
			int index,
			MultiValueMap<String, Integer> mvm) {
		int len = str.length();
